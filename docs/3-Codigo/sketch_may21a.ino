...
void loop(void)
{
  ...
  // Mensagem rodape
  if (valor_sensor >= 0 and valor_sensor <= 180)
  {
  ...
  else if (valor_sensor >= 181 and valor_sensor <= 250)
  {
  ...
  else if (valor_sensor >= 251 and valor_sensor <= 400)
  {
    estado = "Bebeu 2 Cerrvejas";
    Serial.print("DATA,TIME,");
    Serial.print(valor_sensor);
    Serial.print(",");
    Serial.println(linha);
